<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="title" name="title" label="Job Title" placeholder="Software Engineer" type="text"
            ...
            <x-inputs.text-area id="description" name="description" label="Job Description"
                ...
                :value=" old('title', $job->description) " />
            ...
            <x-inputs.text-area id="benefits" name="benefits" label="Benefits"
                placeholder="Health insurance, 401k, paid time off team..." :value="old('benefits', $job->benefits)" />
            ...
            <x-inputs.select id="job_type" name="job_type" label="Job Type" :options="['Full-Time' => 'Full-Time', 'Part-Time' => 'Part-Time', 'Contract' => 'Contract', 'Internship' => 'Internship', 'Volunteer' => 'Volunteer', 'On-Call' => 'On-Call']" :value="old('job_type', $job->job_type)" />
            ...
            <x-inputs.text id="zipcode" name="zipcode" label="Zipcode" type="number" placeholder="12201"
