<x-layout>
	<x-slot name="title" class="text-4xl text-center font-bold mb-4">
		Create Job Listing
	</x-slot>
	<div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
		...
		<form method="POST" action="{{ route('jobs.store') }}" enctype="multipart/form-data">
			...
			<x-inputs.text-area id="benefits" name="benefits" label="Benefits"
				placeholder="Health insurance, 401k, paid time off team..." />
			...
			<x-inputs.select id="job_type" name="job_type" label="Job Type" value="{{ old('job_type') }}"
				:options="['Full-Time' => 'Full-Time', 'Part-Time' => 'Part-Time', 'Contract' => 'Contract', 'Internship' => 'Internship', 'Volunteer' => 'Volunteer', 'On-Call' => 'On-Call'] " />
