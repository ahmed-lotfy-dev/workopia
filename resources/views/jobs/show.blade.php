<x-layout>
  <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div class="container mx-auto p-4">
            ...
            <div x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 opacity-90">
              <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                ...
                <form method="POST" action="{{ route('applicant.store',$job->id) }}" enctype="multipart/form-data">
                  ...
                  <x-inputs.file id="resume" name="resume" label="Upload Your Resume (pdf)" :require="true" />
        ...
        @else
          <p class="my-5 bg-gray-300 rounded-xl p-3">
            ...
            You must be loged in to apply for this job
          </p>
        @endauth
      </div>
    ...
    <aside class="bg-white rounded-lg shadow-md p-3">
      ...
      @guest
        <div class="mt-10 bg-gray-200 text-gray-700 font-bold w-full py-2 px-4 rounded-full text-center">
